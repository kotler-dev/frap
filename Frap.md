...
**Языки:** [English](README.md) · [Русский](Frap.md)
...
Maven:           io.github.kotler-dev:frap-core, :frap-selenide, …
...
|--------|------------|------------|---------------------|
| **npm** | `@frap/sdk` | `@frap/playwright` | — (позже) |
| **Maven** | `io.github.kotler-dev:frap-core` | `…:frap-playwright` | `…:frap-selenide`, `…:frap-selenium` |
| **PyPI** | `frap-sdk` | `frap-playwright` | — |
| **Cargo** | `frap-sdk` | — | — |

`groupId` в Maven: **`io.github.kotler-dev`** (совпадает с verified namespace GitHub `kotler-dev`).  
Java **package**: **`io.github.kotlerdev.frap.*`** (дефис недопустим в идентификаторе пакета).  
...
```bash
npm i @frap/sdk @frap/playwright
```
...
# CLI (если вынесен в bin пакета @frap/sdk)
npx frap --help
