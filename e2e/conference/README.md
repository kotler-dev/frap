...
Локальный demo-проект **FixtureConf 2026 Spring** (статические страницы в [`fixtures/fixtureconf/conference/`](../../fixtures/fixtureconf/conference/)). Вымышленные спикеры и программа, не связаны с реальными конференциями.
...
| Файл | Описание |
|------|----------|
| `e2e/frap-reports/conference/frap-debug.html` | Classic view (A): индекс или один отчёт |
| `e2e/frap-reports/conference/frap-debug-explorer.html` | Explorer (B): sidebar при 2+ debug-тестах; stub при одном |
| `e2e/frap-reports/conference/debug-reports/*.html` | Детальные debug-отчёты |
| `e2e/frap-reports/conference/frap-report.json` | Сводка healing events |
| `e2e/frap-reports/conference/junit.xml` | JUnit с `<healing>` |
| `e2e/frap-reports/conference/frap-events.jsonl` | Поток healing events (проверяется в `zzz-reporting.spec.ts`) |
