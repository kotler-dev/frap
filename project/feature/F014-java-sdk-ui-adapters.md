...
|-------|--------|-----------|
| **A — Core + Playwright Java** | ✅ PoC готов | `sdk/java/frap-core-java`, `adapters/playwright-java`, `examples/java/playwright` |
...
1. Зависимости: `io.github.kotler-dev:frap-core-java` + `io.github.kotler-dev:frap-playwright`.
...
- `examples/java/playwright` — conference + context E2E (`@Tag("e2e")`)
...
- [x] Документация: `examples/java/playwright/README.md`, `adapters/playwright-java/README.md`
...
cd examples/java/playwright && mvn test   # требует test-app + RPC + browsers
```
