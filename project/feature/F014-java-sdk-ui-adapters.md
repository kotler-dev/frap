...
|-------|--------|-----------|
| **A — Core + Playwright Java** | ✅ PoC готов | `sdk/java/frap-core-java`, `adapters/playwright-java`, `examples/java-playwright-demo` |
...
- `examples/java-playwright-demo` — conference + context E2E (`@Tag("e2e")`)
...
- [x] Документация: `examples/java-playwright-demo/README.md`, `adapters/playwright-java/README.md`
...
cd examples/java-playwright-demo && mvn test   # требует test-app + RPC + browsers
```
