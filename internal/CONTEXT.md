...
- **v0.1.0 (MVP)** — F001 + F008: Rebrand + Self-healing + Playwright adapter
- **v0.2.0** — F002 + F003: Unified Context + RCA
- **v0.4.0** — F004 + F005 + F009: Page Object Gen + MCP + Feedback Loop
- **v1.0.0** — F006 + F007 + F010: Multi-platform + Visual Fingerprint + Health Score
- **v2.0.0** — F011: AI-Agent Testing & Audit
