...
Алгоритм Drain3 / ParseTree для полного discovery: [internal/architecture/clustering.md](../../../../architecture/clustering.md).
...
```bash
open internal/demo/showcase/java-playwright/target/frap-reports/conference/frap-debug.html
```
