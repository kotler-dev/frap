...
**Deliverables (MVP):**
- `Frap discover` CLI → element map JSON
...
|-------|----------|-------|------------------|
| **MVP** | Months 1-2 | Layer 1 | `Frap discover`, Core (Rust), Chrome/CDP source |
...
**MCP Integration:**
- Layer 1: `frap/discover` → element map для LLM grounding
- Layer 2: `frap/generate` → output для AI review
