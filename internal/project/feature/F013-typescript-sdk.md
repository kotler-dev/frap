...
1. Пакет `frapcode` подключается как зависимость (monorepo: `file:../sdk/typescript` или npm publish).
...
- [x] F008 adapter зависит от `frapcode`
...
cd ../../e2e && npm test   # косвенно через frapcode
```
