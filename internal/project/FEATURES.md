...
|------|--------|----------|---------|------------|
| [F000: Core Platform API](./feature/F000-core-platform-api.md) | ✅ | Critical | v1.0.0 | P0 WASM + `frapcode-core`; FFI/JSON-RPC → v1.4.0 |
...
| [F003: Root Cause Analysis](./feature/F003-rca.md) | ✅ | High | v1.1.0 | frapcode-rca + WASM; C002/C003 verify-rca |
...
| [F016: IDE Extensions](./feature/F016-ide-extensions.md) | ❌ | Medium | v1.2.0 / v1.4.0 | DX поверх element map; VS Code v1.2, JetBrains/GigaIDE v1.4 |
...
### v1.0.0 MVP
- [x] F000: Core Platform API — P0 WASM + `frapcode-core` (FFI/RPC → v1.4.0)
...
### v1.2.0 AI
- [ ] F004: Page Object Generator — element map + export
- [ ] F005: MCP Integration — JSON-RPC сервер
- [ ] F016: IDE Extensions — Phase 0–1 (schema + VS Code); JetBrains в v1.4.0
...
### Реализовано
- [x] Rust workspace: `signature`, `clustering`, `healing`, `frapcode-core` (`crates/core`)
